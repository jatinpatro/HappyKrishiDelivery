...
function authenticate(req, res, next) {
  ...
  try {
    ...
    const user = db.prepare('SELECT id, name, phone, email, role, wallet_balance, is_active, tier_id, token_version, phone_verified, email_verified FROM users WHERE id = ?').get(payload.id);
